...
insert into user_contact (user_id, type, approved, code, code_trails, code_time, contact) values (1, 'EMAIL', 1, 'code', 0, '2023-05-06 14:04:58.428116', 'w@w.w');
...
insert into book2author (author_id, book_id) values (1, 1, 1);
insert into book2genre (book_id, genre_id) values (1, 1, 1);
