    ...
    $(function () {
        ...
        var Card = function () {
            var bookTemplate = function (book) {
                return '<div class="Card">' + '   <div class="Card-picture">' +
                    '<a href="books/' + book.slug + '">' + '       <img src="' + book.image + '">\n' +
            ...
            //         (book.status === 'KEPT' ? ' <a class="Card-status" title="Отложена"><img src="/assets/img/icons/heart.svg" alt="Отложена"></a>\n' : '') + '    </div>' +
            //         '              <div class="Card-content">\n' + '                <strong class="Card-title"><a href="#">' + book.title + '</a>\n' + '                </strong>\n' +
            //         '                <div class="Card-description">' + (book.author ? book.author : 'no_author') +
            //         '                </div>\n' +
            //         '                <div class="Card-cost">' + (book.discount ? '<span class="Card-priceOld">₽' + book.discount + '</span>\n' : '') +
            //         '                       <span class="Card-price">₽' + book.price + '</span>\n' +
            //         '                </div>\n' + '              </div>\n' + '            </div>';
            // }
            return {
                    ...
                    $('[data-refreshshow]').on('click change', function (e) {
                            ...
                            $.ajax({
                                ...
                                complete: function (result) {
                                    if (result.status === 200) {
                                        ...
                                        // видимость кнопки
                                        var $btn = $('.btn_primary')
                                        if  (result.responseJSON.books.length < $this.data('refreshlimit')) {
                        ...
                        switch (data) {
                            ...
                            case'popular':
                                ...
                                break;
                            case'genre':
                                getData('/books/genre/page/' + $this.data('refreshid'), {
                                    offset: function () {
                                        var oldOffset = $this.data('refreshoffset');
                                        if (oldOffset < 1) {
                                            $this.data('refreshoffset', ++oldOffset);
                            ...
                            case'author':
                                ...
                                break;
                            case'tag':
                                getData('/books/tags/page/' + $this.data('refreshquery'), {
                                    offset: function () {
                                        var oldOffset = $this.data('refreshoffset');
                                        if(oldOffset < 1){
                                            $this.data('refreshoffset', ++oldOffset);
                                ...
                                if ($(slick.$slides[slick.$slides.length - 3]).hasClass('slick-active')) {
                                    if ($(slick.$slider).data('load')) {
                                        ...
                                        switch ($(slick.$slider).data('load')) {
                                            case'recommended':
                                                sendData('/books/recommended/page')
                                                break;
                                            case'recent':
